...
while vehicle.channels['5'] < 1400:		#if Channel 5 is off
	...
	point_list = [0] * 60			# creates a list with 60 entries

	for i in range(2,120,2):
		p1x = far_field * math.sin(60)
		p1y = far_field * math.cos(60)
		p2x = far_field * math.sin(58)
		p2y = far_field * math.cos(58)
		delta_x = p2x - p1x
		delta_y = p2y - p1y
		distance_change = sqrt(delta_x ** 2 + delta_y ** 2)
		point_list[z] = Next_Point()
		z = z + 1
