...
def threedplot():
    ...
    userLocation = "C:\\Users\\Gerardo\\Documents\\Spring 2019\\ECEN 404\\";
    ...
    fFile = userLocation + "freqData_041719.txt"
    gFile = userLocation + "magData_notilt.txt"
    gpsFile = userLocation + "coordData_041719.txt"
...
def mainfun():
    ...
    thetaFile.close()
    phiFile.close()
    return uniquePhi, uniqueTheta, GainH, GainV
